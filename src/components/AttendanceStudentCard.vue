  ...
  v-if="rail"
   ...
   <div v-if="!rail">
    ...
    <v-card-actions class="w-100 d-flex align-center justify-center" v-if="!student.attendance">
      <v-btn prepend-icon="mdi-check" color="primary" variant="outlined" @click.stop="enter">Present</v-btn>
      <v-btn prepend-icon="mdi-close" variant="outlined" color="error" @click.stop="absent">Absent</v-btn>
    </v-card-actions>
    ...
    <v-card-actions v-else-if="!!student.attendance.time_in" class="w-100">
      <v-btn color="error"  variant="elevated" @click.stop="leave(student.id, student.attendance.id)" prepend-icon="mdi-logout" block v-if="student.attendance.time_in ">Leave</v-btn>
    </v-card-actions>
